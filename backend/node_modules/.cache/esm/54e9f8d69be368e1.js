let Bookmarks,Content,Like,Tutors,Playlist,Comments,Note,CustomErrorHandler;_9be‍.x([["default",()=>_9be‍.o]]);_9be‍.w("../../models",[["Bookmarks",["Bookmarks"],function(v){Bookmarks=v}],["Content",["Content"],function(v){Content=v}],["Like",["Like"],function(v){Like=v}],["Tutors",["Tutors"],function(v){Tutors=v}],["Playlist",["Playlist"],function(v){Playlist=v}],["Comments",["Comments"],function(v){Comments=v}],["Note",["Note"],function(v){Note=v}]]);_9be‍.w("../../services/CustomErrorHandler",[["default",["CustomErrorHandler"],function(v){CustomErrorHandler=v}]]);
...
const userController = {
  ...
  async addPlaylist (req, res, next) {
    ...
    try {
      ...
      _9be‍.g.console.error('backend', err)
