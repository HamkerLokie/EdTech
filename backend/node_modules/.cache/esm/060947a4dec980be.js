let Joi,User,Tutors,bcrypt,SALT,JwtService,CustomErrorHandler;_dec‍.x([["default",()=>_dec‍.o]]);_dec‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);_dec‍.w("../../models",[["User",["User"],function(v){User=v}],["Tutors",["Tutors"],function(v){Tutors=v}]]);_dec‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_dec‍.w("../../config",[["SALT",["SALT"],function(v){SALT=v}]]);_dec‍.w("../../services/JwtService",[["default",["JwtService"],function(v){JwtService=v}]]);_dec‍.w("../../services/CustomErrorHandler",[["default",["CustomErrorHandler"],function(v){CustomErrorHandler=v}]]);
...
const Authentication = {
  async register (req, res, next) {
    ...
    _dec‍.g.console.log(access_token)
